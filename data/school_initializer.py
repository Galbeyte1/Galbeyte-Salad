...
#           dump __init__ code from gradebook to the here
    def __init__(self):

        #create a data collection of students
        self.students = {}
        ...
        #create a data collection of courses
        self.courses = {}
        ...
        #create a data collection of enrollments
        self.enrollments = {}
